	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function removeItem(itemIndex) {
	      this.props.dispatch((0, _actions.doneItemAction)(itemIndex));
	    }
	  }, {
	    key: 'addItem',
	    value: function addItem() {
	      this.props.dispatch((0, _actions.addItemAction)(this.refs.input.value));
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'App ee--panel ee--vcenter', style: { marginTop: 20 } },
	        _react2.default.createElement('input', { ref: 'input', className: 'App--input', style: { width: 500 }, placeholder: 'Item Text', type: 'text' }),
	        _react2.default.createElement(
	          'div',
	          { className: 'App--add ee--button', onClick: this.addItem.bind(this), style: { marginTop: '10px', float: 'right' } },
	          'add'
	        ),
	        _react2.default.createElement(
	          'ul',
	          ...
	          this.props.items.map(function (item, i) {
	            ...
	            return _react2.default.createElement(
	              ...
	              !item.isDone ? _react2.default.createElement(
	                'a',
	                { href: '#', style: { marginLeft: 10 }, onClick: _this2.removeItem.bind(_this2, i) },
	                'done'
	              ) : _react2.default.createElement(
	                'span',
	                { style: { color: '#aaaaaa' } },
	        ...
	        _react2.default.createElement(
	          'div',
	          {
	            ...
	            onClick: function onClick() {
	              return dispatch((0, _actions.showAllAction)());
	            },
	        ...
	        _react2.default.createElement(
	          'div',
	          {
	            ...
	            onClick: function onClick() {
	              return dispatch((0, _actions.showTodoAction)());
	            },
	            style: filterButtonsStyle },
	          'Show todo'
	        ),
	        _react2.default.createElement(
	          'div',
	          {
	            ...
	            onClick: function onClick() {
	              return dispatch((0, _actions.showDoneAction)());
	            },
	            style: filterButtonsStyle },
	          'Show done'
	        )
...
/***/ function(module, exports) {
	...
	exports.doneItemAction = doneItemAction;
	exports.showAllAction = showAllAction;
	exports.showTodoAction = showTodoAction;
	exports.showDoneAction = showDoneAction;
	var ADD_ITEM = exports.ADD_ITEM = 'ADD_ITEM';
	var DONE_ITEM = exports.DONE_ITEM = 'DONE_ITEM';
	var SHOW_ALL = exports.SHOW_ALL = 'SHOW_ALL';
	var SHOW_TODO = exports.SHOW_TODO = 'SHOW_TODO';
	var SHOW_DONE = exports.SHOW_DONE = 'SHOW_DONE';
	...
	function showTodoAction() {
	  return {
	    type: SHOW_TODO
	  };
	}

	function showDoneAction() {
	  return {
	    type: SHOW_DONE
	  };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function filterReducer() {
	  ...
	  switch (action.type) {
	    ...
	    // show done
	    case _actions.SHOW_DONE:
	      return 'done';
	      break;

	    // show todo
	    case _actions.SHOW_TODO:
	      return 'todo';
	      break;

	    // show all
	    case _actions.SHOW_ALL:
	      return 'all';
	      break;
